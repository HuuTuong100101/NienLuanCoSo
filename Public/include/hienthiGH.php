...
<div class="row" style="margin: 10px 30px;">
    ...
    ?>
                    ...
                    <tbody class="cart-body-border">
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="giohang.php?action=cong&idsp=<?php echo $idsp;?>" class="btn bg-color">+</a>
                                    <?php echo $cart_item['soluong']; ?>
                                    <a href="giohang.php?action=tru&idsp=<?php echo $idsp;?>" class="btn bg-color">-</a>
                                </div>
                            </td>
                            <td><?php echo number_format($cart_item['giasp'],0,',','.'); ?></td>
                            <td><?php echo number_format($SUM,0,',','.'); ?></td>
                            <td><a href="giohang.php?action=xoagiohang&idsp=<?php echo $idsp;?>" class="btn btn-outline-light bg-color white-color" style="width: 100%;">Xóa</a></td>
                        </tr>
                    <?php
                    ...
                    ?> 
                        <tr>
                            ...
                            <td><a href="?action=dathang&user=<?php echo $_SESSION['loginkh'] ?>" class="btn btn-outline-light bg-color white-color" style = "width: 100%;">Đặt hàng</a></td>
                        </tr>
                    <?php 
                    } 
                    ?>
    ...
    ?>
        ...
        <a href="index.php?action=TC" style="border-color: #f12711;" class="btn bg-color white-color">Tiếp tục mua hàng</a>
        </div>
