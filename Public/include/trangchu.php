...
<div class="row" style="margin-bottom: 30px;">
    <div class="col-12 padding-b-20">
        <div class="row padding-l-20">
            ...
            ?>
                    <div href="#" class="card padding" style="width: 14rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="giohang.php?action=themgiohang&idsp=<?php echo $row['ma_sp'] ;?>" class="btn bg-color white-color" style ="font-weight:bold; width: 100%;">Mua hàng</a>
                        </div>
                    </div>
            <?php 
                } 
    ...
    <div class="text-center padding-l-20">
        ...
        <div class="btn-group me-2" role="group" aria-label="Second group">
            <?php 
                for($i=1 ; $i<=$sotrang; $i++) {
            ?>
                <a <?php if($i==$page) { echo "style = 'background-color: #f12711; color: white;'"; }; ?> href="?action=trangchu&trangdm=<?php echo $i; ?>" class="btn btn-secondary"><?php echo $i; ?></a>
            <?php } ?>
        </div>
    </div>
</div>
