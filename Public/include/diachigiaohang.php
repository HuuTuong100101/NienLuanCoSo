    ...
    <div class="col-md-6 offset-md-3">
        <div class="form-dky">
            <form class="p-5" method = "POST" autocomplete = "off" action ="giohang.php?<?php if($_GET['action'] == 'dcgh') {echo 'action=dcgh' ;} else{echo 'action=tddcgh';} ?>">
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Tỉnh/thành phố</label>
                ...
                <div>
                    <button style = "font-size: 20px; font-weight: bold ; width: 100%;" type="submit" class="btn bg-color white-color">Thêm Địa Chỉ</button>
                </div>
                <div class="mb-3" style="margin-top: 20px">
                    <p><a href="index.php" style="color: red;">Quay lai trang chủ</a></p>
                </div>
            </form>
        </div>
    </div>
