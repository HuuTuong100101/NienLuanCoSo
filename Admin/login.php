            ...
            <div class="col-md-6 offset-md-3">
                    <div class="form-dky">
                        <form class="p-5" method = "POST" autocomplete = "off" action="login.php">
                            <div>
                                <p style ="text-align: center; font-weight: Bold; font-size: 30px" class = "key-color-admin">ĐĂNG NHẬP ADMIN</p>
                            </div>
                            <div class="mb-3">
                            ...
                            <button style = "font-size: 20px; font-weight: bold; margin-top: 20px;" type="submit" class="btn btn-admin white-color" name="login_ad">Đăng nhập</button>
                        </form>
                    </div>
            </div>
        </div>
